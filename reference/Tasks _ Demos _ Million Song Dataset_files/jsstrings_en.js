...
// DEPENDS ON: ['codegen\\resx-strings-js.template', 'D:/tc/builds/public-release/public-release.17.0124.1057/workgroup/vqlweb/scriptsharp/src/Resources/Strings/Strings.en.resx', 'D:/tc/builds/public-release/public-release.17.0124.1057/workgroup/vqlweb/scriptsharp/src/Resources/Strings/Strings.en.resx']
...
(function(w) {
  var s = {
    ...
    DataAlertAboveOrEqualSubjectText: "\'{0}\' is above or equal to {1}",
    DataAlertAboveSubjectText: "\'{0}\' is above {1}",
    DataAlertBelowOrEqualSubjectText: "\'{0}\' is below or equal to {1}",
    DataAlertBelowSubjectText: "\'{0}\' is below {1}",
    ...
    DataAlertEqualSubjectText: "\'{0}\' is equal to {1}",
    DataAlertOnConstantThreshold: "Set alert on \'{0}\' for any bar",
    DataAlertSchedulePicker: "Check Threshold",
    DataAlertSubject: "Subject",
    DataAlertThreshold: "Threshold",
    DataAlertThresholdError: "Value must be a number",
    ...
    EditDeliveryOptions: "Edit Delivery Options",
    ...
    GotoMyLocationPermissionDeniedUnsecureConnection: "In this version of Google Chrome, geolocation requests will not work with an unsecured connection.",
    ...
    ToolbarCustomViewsDefault: "(Default)",
    ...
    ToolbarCustomViewsOriginalView: "Original View",
    ...
    UnhandledExceptionMessage: "An unexpected error occurred. If you continue to receive this error please contact your Tableau Server Administrator.<br><br>{0}",
