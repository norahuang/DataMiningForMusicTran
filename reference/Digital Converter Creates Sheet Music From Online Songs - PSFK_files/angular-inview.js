...
(function() {
    ...
    bindWindowEvents = function() {
        ...
        return angular.element(".inview_container").bind('checkInView click ready scroll resize', windowEventsHandler);
    };
    ...
    unbindWindowEvents = function() {
        ...
        _windowEventsHandlerBinded = false;
        return angular.element(".inview_container").unbind('checkInView click ready scroll resize', windowEventsHandler);
    };
...
//      elOffsetTop = getBoundingClientRect(item.element[0]).top + window.pageYOffset;
            elOffsetTop = getBoundingClientRect(item.element[0]).top + jQuery(".inview_container").offset().top;
...
//    height = window.innerHeight;
        height = jQuery(".inview_container").innerHeight();
        if (height) {
            return height;
        }
